		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App4",
									"targetURL": "#comhemanthappsproject4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhemanthappsproject4-display": {
								"semanticObject": "comhemanthappsproject4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hemanth.apps.project4",
									"url": sap.ui.require.toUrl("com/hemanth/apps/project4")
								}
							}
						}
					}
